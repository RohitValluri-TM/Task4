  ...
  return (
    <div className="app">
      ...
      <h1 id="lgtxt">LOGIN</h1>
        ...
        <label>Email : </label>
        <input id="inpt" name="email" value={formdata.email} onChange={(e)=>handleChange(e)}></input>
